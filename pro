...
void our_project()
{
    ...
    printf ("В програмі реалізовані головні вимоги інтернет магазину\n");
    printf ("Це можливість переглядати каталог\n");
    printf ("Знаходити товар по коду\n");
    printf ("Фільтр товарів відповідно до розміру, ціни та гендеру\n");
    printf ("Додавання та видалення товару з кошику\n");
    printf ("Перегляд товарів в кошику\n");
    printf ("Оформлення замовлення та остаточна загальна ціна\n");
    printf ("Проєкт виконали студенти ІПЗ-22007б\n");
    printf ("Дацюк Неля\n");
